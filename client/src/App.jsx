...
export const App = () => {
  ...
  return (
    <ThemeSelector>
      <Toaster />
      <div>
        <div id="topRow" className="navbar mb-10 bg-base-100">
          ...
          <div className="navbar-end">
            <a href="https://discord.gg/k7C8kp3b76" rel="noreferrer" target="_blank" className="btn btn-ghost btn-circle">
            ...
            <a href="https://github.com/iqengine/iqengine" rel="noreferrer"target="_blank" className="btn btn-ghost btn-circle">
